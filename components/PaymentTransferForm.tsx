...
const PaymentTransferForm = ({ accounts }: PaymentTransferFormProps) => {
  ...
  const submit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // Debug: Check the structure of both banks
      console.log("Sender Bank structure:", {
        userId: senderBank.userId,
        userIdType: typeof senderBank.userId,
        id: senderBank.$id,
      });

      console.log("Receiver Bank structure:", {
        userId: receiverBank.userId,
        userIdType: typeof receiverBank.userId,
        id: receiverBank.$id,
      });
